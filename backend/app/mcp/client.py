...
_TOOL_CATALOG: list[dict[str, Any]] = [
    ...
    {
        "name": "list_tables",
        "description": "List approved application tables and role-aware record-read capability. PostgreSQL system tables are never exposed.",
        "input_schema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "Read one bounded page from an approved table without accepting raw SQL. Operational table records require admin role.",
        "input_schema": {
            "type": "object",
            "properties": {
